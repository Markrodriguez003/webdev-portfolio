export const projects = [
  ...
  // ****************************************************************************
  {
    ...
    content: [
      `While working at a law firm, I recognized that they needed a more efficient way to download SEC filings & related data.`,
      `By leveraging the SEC-api.io API I was able to extract up-to-date data from the SEC.gov website by company CIK number. User would need their own API key.`,
      `I then organized and presented in a user-friendly interface.`,
      `I implemented features for users to easily search, view & filter the data via a comprehensive table.`,
    ],
    technologies: [
      "Typescript",
      "React",
    ...
    techniques: [
      "Designed application as a solution to a tedious and complex workplace problem of searching & downloading SEC filings and related data.",
      "Implemented API calls to extract data from the SEC.gov website using SEC-api-io.",
      "Form Validation & submission",
      "Handled write file & file export (.csv, .pdf, .xls, & .docx) using NPM libraries",
    ...
    futureUpdates: [
      "Offer more SEC company data extraction options",
      "Implement web scraping ",
      "Include more robust filtering options for data tables",
      "Add .xml file export option",
