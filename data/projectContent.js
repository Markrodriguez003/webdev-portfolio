export const projects = [
  ...
  // ****************************************************************************
  {
    ...
    content: [
      ...
      `Metrics & data are being retreived via backend. All charts are set up using ChartJS.`,
  ...
  // ****************************************************************************
  {
    ...
    content: [
      ...
      `Users will be able to search company information, subsidaries data, executive compensation, & SEC fillings via a simple to use form. All form inputs are validated for accuracy & completeness.`,
    ...
    techniques: [
      ...
      "Created standalone executable program using ElectronJS & Node.js",
    ],
    futureUpdates: [
  ...
  // ****************************************************************************
  // GYAN-BET FRIENDLY BETTING SITE
  // ****************************************************************************

  {
    key: 4,
    title: "Gyan-Bet (WIP)",
    subHeader: "Friendly Personal Betting Site.",
    content: [
      `It was becoming difficult to track friendly NHL bets between friends, so I developed this application to help organize, initiate, & track bets! `,
      `Games available for betting are pulled directly from an official NHL API, & users can bet on games with virtual currency! `,
      `All NHL data is pulled from an official NHL API using Axios. This includes game data, team data, player data & standings. `,
      `Users will also be able to pull up the latest scores, or look for prior scores from previous games! All games will have a recap video link for easy viewing!`,
      `In addition to game betting, & score viewing, users will also be able to see their team, hopefully winning, in the standings, alongside playoff chances & odds.`,
      `Betting confirmation slips can be downloaded as PDF files using jsPDF library, printed or sent via any application. Time to gloat to your friends on who won the bet!`,
    ],
    technologies: [
      "Typescript",
      "React",
    ...
    techniques: [
      "Created application with React, Typescript, React-Router, to track bets & connect with my friends during NHL season",
      "Styled fully responsive application using CSS & Grommet",
      "Created utility functions to handle sorting, filtering, date & time conversion, & data organization",
      "Created scripts that allow user to print, copy, or download bet confirmation slips as PDF using jsPDF, html-react-parser & html2canvas",
      "Configured & utilized Firebase for user authentication, alongside Firestore for bet & user data storage/retrieval",
      "Form field verification & validation using Yup & React-Hook-Form",
    ],
    futureUpdates: [
      "Create stand alone application with React-Native",
      "Add new sports (NBA, NFL, MLB)",
      "Continuous score & game data updates during live games",
      "Include more betting odds types (Over/Under, Prop Bets, Parlay Bets)",
      "Betting Rooms with chat functionality",
    ],
    youtube: "#",
    github: "https://github.com/Markrodriguez003/kakeru",
    site: "#",
    images: [
      "gyan-bet-1.png",
      "gyan-bet-2.png",
  ...
  // ****************************************************************************
  {
    ...
    content: [
      ...
      `I designed & produced this site to showcase my portfolio pieces, skills & resume. `,
